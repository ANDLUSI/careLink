      ...
      <div class="main-page">
        <div class="grids widget-shadow">
          ...
          <ul class="list-group">
            ...
            <li v-for="role in roles" :key="role.id" class="list-group-item d-flex">
              <div class="table_top">
                <!-- 渲染突发事件的具体数据 -->
                <div>{{ role.id }}</div>
                <div>{{ role.name }}</div>
                ...
                <span class="op_btn">
                  ...
                  <a class="btn btn_style_lo btn-sm" @click="detail(role.id)">详情</a>
                  <a class="btn btn_style_mo btn-sm" @click="modify(role.id)">修改</a>
                  <a class="btn btn_style_del btn-sm" @click="remove(role.id)">删除</a>
                </span>
              </div>
            </li>
          </ul>
...
import {addRole, deleteRole, modifyRole, showList} from "@/api/user/role";
